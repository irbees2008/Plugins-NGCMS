	...
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td style="background-image:url('{tpl_url}/images/2z_41.gif');" width="100%">{title}</td>
	...
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td style="background-image:url('{tpl_url}/images/2z_50.gif');" width="100%"><b>Дата: </b>{date} | <b>Оставил: </b>{author}</td>
	...
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td style="background-image:url('{tpl_url}/images/2z_64.gif');" width="100%" class="mw_links"><b>{rating}</b></td>
