	...
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td style="background-image:url('{tpl_url}/images/2z_50.gif');" width="100%"></td>
	...
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td bgcolor="#FFFFFF">{infomessage}</td>
	...
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td style="background-image:url('{tpl_url}/images/2z_64.gif');" width="100%" class="mw_links">{url}</td>
