...
WBBLANG['en'] = CURLANG = {
	...
	offtop: "Offtop",
	code: "Code",
	more: "Разделитель краткого и полного содержания",
	spoiler: "Spoiler",
...
//			direction:			"ltr",
			...
			buttons: 			"bold,italic,underline,strike,sup,sub,|,img,video,link,smilebox,|,bullist,numlist,|,fontcolor,fontsize,fontfamily,|,justifyleft,justifycenter,justifyright,|,quote,code,more,table,removeFormat",
			allButtons: {
				bold : {
					title: CURLANG.bold,
                    ...
                    modal: {
                        ...
                        tabs: [
                            ...
                            { //The second tab
                                ...
                                html: '<div id="imguploader"> <form id="fupform" class="upload" action="{php_self}?mod=images" method="post" enctype="multipart/form-data" target="fupload"><input type="hidden" name="iframe" value="1"/><input type="hidden" name="idarea" value="' + id + '" /><div class="fileupload"><input id="fileupl" class="file" type="file" name="img" /><button id="nicebtn" class="wbb-button">' + CURLANG.modal_img_btn + '</button> </div> </form> </div><iframe id="fupload" name="fupload" src="{php_self}?mod=images" frameborder="0" style="width:0px;height:0px;display:none"></iframe></div>'
                            }
                        ],
		...
		imgLoadModal: function() {
			...
			if (this.options.imgupload===true) {
				...
				this.$modal.find("#fupform").bind("submit",$.proxy(function(e) {
					$(e.target).parents("#imguploader").hide().after('<div class="loader"><img src="/engine/skins/default/images/loading.gif" /><br/><span>'+CURLANG.loading+'</span></div>').parent().css("text-align","center");
				},this))
		...
		init: function() {
			if (window.FormData != null) {
				...
				this.$block[0].ondrop = $.proxy(function(e) {
					...
					this.$loader = $('<div class="loader"><img src="/engine/skins/default/images/loading.gif" /><br/><span>'+CURLANG.loading+'</span></div>');
