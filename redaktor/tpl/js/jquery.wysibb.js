...
//			direction:			"ltr",
			...
			buttons: 			"bold,italic,underline,strike,sup,sub,|,img,ngimg,video,link,smilebox,|,bullist,numlist,|,fontcolor,fontsize,fontfamily,|,justifyleft,justifycenter,justifyright,|,spoiler,quote,code,more,table,removeFormat",
			allButtons: {
				bold : {
					title: CURLANG.bold,
