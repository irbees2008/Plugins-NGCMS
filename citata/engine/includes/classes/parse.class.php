...
class parse {
	...
	function bbcodes($content) {
		...
		$content	=	preg_replace("#\[quote\]\s*(.*?)\s*\[/quote\]#is", '<div class="bbQuoteBlock"><div class="bbQuoteName" ><b>Цитата</b> </div><div class="quoteMessage"><blockquote><b>'.$lang['bb_quote'].'</b><br />$1</blockquote></div></div>',$content);
